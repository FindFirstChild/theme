...
function RMA.CreateIcon(Xame,Xmage,Xosition,XnchorPoint)
	...
	function Icon.OnClick(Func,DisconnectAfterRuns)
		local MB1=Label.MouseButton1Click
		if DisconnectAfterRuns then
			MB1:Once(Func)
			return
		end
		MB1:Connect(Func)
...
function RMA.CreateButtonOld(Xame,Xext,Xosition,XnchorPoint)
	...
	function Buttons.OnClick(Func,DisconnectAfterRuns)
		local MB1=Button.MouseButton1Click
		if DisconnectAfterRuns then
			MB1:Once(Func)
			return
		end
